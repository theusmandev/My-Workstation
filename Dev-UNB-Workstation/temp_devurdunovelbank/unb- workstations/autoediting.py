...
# 📁 Input & Output 
input_folder = r"E:\SUNB\Writers All Novels\Sabir CH Books\ok\pngs"
...
# input_folder = r"C:\Users\PCS\Downloads\Hashim Nadeem Novels\pngsokok"
# output_folder = os.path.join(input_folder, 'thumbnails_1000x667')
# os.makedirs(output_folder, exist_ok=True)
...
# # ✍️ Text watermark settings
# font_path = r"C:\Users\PCS\Downloads\Roboto_Slab\static\RobotoSlab-Black.ttf"
# font_size = 32
# font = ImageFont.truetype(font_path, font_size)

# # 📌 Function: choose text color automatically
# def get_text_color(avg_color):
#     # brightness formula: 0 (dark) to 255 (bright)
...
#         # ✍️ Add website text (always inside thumbnail)
#         draw = ImageDraw.Draw(composite)
#         text = "www.urdunovelbanks.com"
...
#         safe_margin = 20
#         text_y = thumb_height - text_height - safe_margin
...
#         # ✅ Ensure text always stays inside canvas
#         safe_margin = 20
#         text_y = thumb_height - text_height - safe_margin
