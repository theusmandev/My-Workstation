...
# 🚀 Google Drive Mount Karna (Agar File Drive Me Save Karni Ho)
from google.colab import drive
drive.mount('/content/drive')

# 📌 File Paths
SITEMAP_URL = "https://urdureadings.com/post-sitemap3.xml"
SAVE_PATH = "/content/drive/My Drive/Blogger_Novels.xlsx"  # Google Drive me Save karne ke liye
PROGRESS_FILE = "/content/drive/My Drive/progress.txt"  # Google Drive me progress save karne ke liye
...
if os.path.exists(PROGRESS_FILE):
    ...
    last_index = 0  # Start from scratch if no progress file exists
...
print(f"✅ Scraping complete! Data saved in '{SAVE_PATH}' (Google Drive)")
