...
IMAGE_WIDTH = 1200
IMAGE_HEIGHT = 630
FONT_PATH = r"E:\SUNB\urdu poetry bank\NotoNastaliqUrdu-Regular.ttf"  # Use static font
FALLBACK_FONT_PATH = r"E:\SUNB\urdu poetry bank\JameelNooriNastaleeq.ttf"  # Replace with valid path
FONT_SIZE = 50
...
def load_font(font_path, size):
    ...
    font_paths = [font_path, FALLBACK_FONT_PATH]
    for path in font_paths:
        if "VariableFont" in path:
            print(f"Warning: Variable font detected ({path}). Variable fonts may not render correctly. Use a static font like NotoNastaliqUrdu-Regular.ttf.")
    ...
    print("Error: No valid Urdu font found.")
    print("Download 'Noto Nastaliq Urdu' (static version) from https://fonts.google.com/noto/specimen/Noto+Nastaliq+Urdu")
    print("Or download 'Jameel Noori Nastaleeq' from https://www.urdujahan.com/fonts.html")
    return None
