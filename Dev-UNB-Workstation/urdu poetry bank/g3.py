...
IMAGE_WIDTH = 1200
IMAGE_HEIGHT = 630
FONT_PATH = r"E:\SUNB\urdu poetry bank\NotoNastaliqUrdu-Regular.ttf"
FALLBACK_FONT_PATH = r"E:\SUNB\urdu poetry bank\JameelNooriNastaleeq.ttf"  # Replace with a valid path if available
FONT_SIZE = 50
...
def load_font(font_path, size):
    ...
    print("Error: No valid font found. Please provide a working Urdu font.")
    return None
    ...
    try:
        ...
        for line in bidi_text.split('\n'):
            ...
            for w in words:
                ...
                if w_width == 0:  # Skip if text doesn't render
