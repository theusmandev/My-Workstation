...
json_file_path = r"D:\workstation\writers\digest\Digest.json"

# Input search name
search_name = "Subrang"  # Case-insensitive search term
...
try:
    ...
    if filtered_df.empty:
        ...
        excel_output_path = fr"D:\workstation\writers\digest\{search_name}.xlsx"
